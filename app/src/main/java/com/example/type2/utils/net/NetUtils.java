...
import com.example.type2.entity.UpLoadDatas;
import com.example.type2.http.MultipartEntity;
import com.example.type2.http.content.ContentBody;
import com.example.type2.http.content.FileBody;
import com.example.type2.http.content.StringBody;
import com.example.type2.utils.CustomRunnable;
import com.example.type2.utils.FileUitls;
import com.example.type2.utils.LoadImageRespone;
...
public class NetUtils {
	 ...
	 * @return
	 */
	public static HttpAsyncTask sendRequest(HttpDatas datas, Context context, HttpAsyncTask.TaskCallBack callback) {
	 ...
	 * @return
	 */
	public static HttpAsyncTask sendRequest(HttpDatas datas, Context context, String dialogStr, HttpAsyncTask.TaskCallBack callback) {
